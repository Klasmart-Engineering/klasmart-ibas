...
export default function Home(props) {
  ...
  const points = content?.attributes.about_us_features?.map((feature) => ({
    id: feature.id,
  ...
  const teachers = content?.attributes.teachers?.map((teacher) => ({
    id: teacher.id,
  ...
  const reviews = content?.attributes.user_review?.map((review) => ({
    id: review.id,
    job: review.job,
    name: review.name,
  ...
  return (
    <LayoutWrapper>
      <PageSEO
        ...
        image={siteMetadata.attributes.image.data.url}
      />
      <section
        ...
        <div className="flex h-screen items-center justify-center md:mt-28 max-w-5xl w-full m-auto flex-col md:flex-row ">
          <div className="w-full md:w-3/5 md:h-auto">
            <h1 className="font-bold text-3xl md:text-5xl leading-tight text-gray-700 pb-6 text-left">
              {content?.attributes.hero_title}
            </h1>
            <div className="mb-3">
              {content?.attributes.featured?.map(({ title = '' }) => (
                <div
                  key={title}
            ...
            >
              {content?.attributes.hero_subtitle}
            </h2>

            <div className="flex pt-12 text-left items-start md:items-center justify-start flex-col md:flex-row">
              <TryButton>{content?.attributes.hero_primary_btn}</TryButton>
              <div className="px-0 py-2 md:px-2 md:py-0" />
              <VideoButton>
                <IoPlayCircleOutline size={22} className="mr-2" /> {content?.attributes.hero_secondary_btn}
              </VideoButton>
            </div>
          </div>
      ...
      <section className="relative hidden md:block">
        <div className="max-w-5xl mx-auto py-16 justify-between w-full border-b">
          <div className="flex items-start  justify-between w-full space-x-6">
            {content?.attributes.hero_statistic?.map(({ title = '', description = '' }) => {
              return (
        ...
        <div className="max-w-5xl mx-auto py-16 justify-between w-full border-b">
          <div className="flex items-center  justify-between w-full space-x-6">
            <div className="p-3 flex-grow w-full">
              <h1 className="font-bold text-3xl text-gray-700 text-center">
                {content?.attributes.hero_statistic[1].title}
              </h1>
              <p className="bold text-sm text-gray-700 text-center">
                {content?.attributes.hero_statistic[1].description}
              </p>
            </div>
          </div>
          <div className="flex items-center pt-3 px-3 justify-between w-full space-x-6">
            <div className="p-3 flex-grow w-1/2">
              <h1 className="font-bold text-3xl text-gray-700 text-center">
                {content?.attributes.hero_statistic[0].title}
              </h1>
              <p className="bold text-sm text-gray-700 text-center">
                {content?.attributes.hero_statistic[0].description}
              </p>
            </div>
            <div className="p-3 flex-grow w-1/2">
              <h1 className="font-bold text-3xl text-gray-700 text-center">
                {content?.attributes.hero_statistic[2].title}
              </h1>
              <p className="bold text-sm text-gray-700 text-center">
                {content?.attributes.hero_statistic[2].description}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl flex items-center justify-center mx-auto py-24 pt-6 md:pt-24 flex-col md:flex-row px-6 md:px-0">
            <div className="md:pr-12 w-full md:w-1/2">
              ...
              <h1 className="font-bold text-3xl md:text-5xl pb-6 text-gray-700">
                {content?.attributes.programs[0]?.title}
              </h1>
              {/* {content?.attributes.programs[0]?.description.split('.')} */}
              <Markdown className="bold text-md md:text-lg text-gray-600">
                {content?.attributes.programs[0]?.description}
              </Markdown>
            </div>
            <div className="md:pl-12 w-full md:w-1/2 pt-24 md:pt-0">
              <ul className="rounded-xl p-8 shadow-lg relative">
                ...
                <li className="flex items-start pb-6 w-2/3">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[0]?.age_label}</p>
                    <p className="font-bold text-gray-700">{content?.attributes.programs[0]?.age}</p>
                  </div>
                </li>
                <li className="flex items-start pb-6  w-2/3">
                  <div className="text-purple-400">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[0]?.grade_label}</p>
                    <p className="font-bold text-gray-700">{content?.attributes.programs[0]?.grade}</p>
                  </div>
                </li>
                <li className="flex items-start pb-6  w-2/3">
                  <div className="text-purple-400">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[0]?.duration_label}</p>
                    <p className="font-bold text-gray-700 md:w-44">
                      {content?.attributes.programs[0]?.duration}
                    </p>
                  </div>
                </li>
        ...
        <section className="relative block md:hidden">
          <div className="max-w-5xl flex items-center justify-center mx-auto py-24 pt-6 md:pt-24 flex-col md:flex-row px-6 md:px-0">
            <div className="md:pr-12 w-full md:w-1/2">
              ...
              />
              <h1 className="font-bold text-3xl md:text-5xl pb-6 text-gray-700">
                {content?.attributes.programs[1]?.title}
              </h1>
              <Markdown className="bold text-md md:text-lg text-gray-600">
                {content?.attributes.programs[1]?.description}
              </Markdown>
            </div>
            <div className="md:pl-12 w-full md:w-1/2 pt-24 md:pt-0">
              <ul className="rounded-xl p-8 shadow-lg relative">
                ...
                <li className="flex items-start pb-6 w-2/3">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[1]?.age_label}</p>
                    <p className="font-bold text-gray-700">{content?.attributes.programs[1]?.age}</p>
                  </div>
                </li>
                <li className="flex items-start pb-6 w-2/3">
                  <div className="text-yellow-400">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[1]?.grade_label}</p>
                    <p className="font-bold text-gray-700">{content?.attributes.programs[1]?.grade}</p>
                  </div>
                </li>
                <li className="flex items-start pb-6 w-2/3">
                  <div className="text-yellow-400">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[1]?.duration_label}</p>
                    <p className="font-bold text-gray-700">{content?.attributes.programs[1]?.duration}</p>
                  </div>
                </li>
                {/* <h1 className="hover:text-primary-300 cursor-pointer text-primary-500 border-b-2 border-primary-500 w-24 text-center border-dashed">
                  SEE DETAIL
              ...
              <ul className="rounded-xl p-8 shadow-lg relative">
                ...
                <li className="flex items-start pb-6 w-2/3">
                  ...
                  <div className="pl-6">
                    <p className="text-xs text-gray-500">{content?.attributes.programs[1]?.duration_label}</p>
                    <p className="font-bold text-gray-700 md:w-44">
                      {content?.attributes.programs[1]?.duration}
                    </p>
                  </div>
                </li>
                {/* <h1 className="hover:text-primary-300 cursor-pointer text-primary-500 border-b-2 border-primary-500 w-24 text-center border-dashed">
            ...
            >
              <div className="w-full md:w-1/2 md:h-auto">
                <h1 className="font-bold text-3xl md:text-3xl leading-tight text-gray-700 pb-6 text-center md:text-left">
                  {content?.attributes.curiculum_title}
                </h1>
                <div className="flex pt-12 text-left items-center justify-start flex-col md:flex-row">
                  <TryButton>{content?.attributes.curiculum_action_btn}</TryButton>
                </div>
              </div>
      ...
      <Element name="reviews" id="reviews">
        <section className="relative">
          <div className="py-16 justify-between w-full items-center flex flex-col">
            ...
            >
              {content?.attributes.user_review_pils}
            </span>
            <h1 className="hidden md:block max-w-5xl mx-auto font-bold text-3xl md:text-5xl leading-tight text-gray-700 pt-6 pb-0 text-center px-6 md:px-0">
              ...
              {content?.attributes.user_review_title}
        ...
        <div className="mx-auto py-16 justify-start w-full items-start flex flex-col">
          <div className="max-w-5xl mx-auto w-full px-6 md:px-0">
            ...
            <span
              ...
              style={{ background: '#FBF0D0', color: '#CD9B0B' }}
            >
              {content?.attributes.our_teacher_pils}
            </span>
          </div>
      ...
      >
        <div className=" flex items-center justify-center max-w-5xl w-full m-auto flex-col md:flex-row border-b border-indego-100 px-6 md:p-0 md:pb-28">
          <div className="w-full md:w-1/2 md:h-auto">
            ...
            <div className="flex pt-12 text-left items-start md:items-center justify-start flex-col md:flex-row">
              <TryButton>{content?.attributes.footer_action_btn}</TryButton>
              <div className="px-0 py-2 md:px-2 md:py-0" />
          ...
          <div className="w-full h-full flex-grow md:w-1/2 hidden md:block md:pl-20">
            <div className=" w-full rounded-xl border-r-8 h-96 border-yellow-500 overflow-hidden relative">
              <Image
                ...
                src={content?.attributes.footer_image?.data.attributes.url}
                alt="footer"
                layout="fill"
                objectFit="cover"
              />
...
export async function getServerSideProps({ locale }) {
  ...
  const content = await axios.get(cmsUrl).then((res) => res.data['data'])

  const metaUrl = url(`seos`)
  const siteMetadata = await axios.get(metaUrl, { params: { path: '/', populate: 'image' } }).then((res) => res.data['data'])
